...
{  
	...
	$numofshares = $_POST['shares']; //Number of Shares Bought ***
	$balance = $balance - ($numofshares*$CurrentPrice*.05); //New Balance after purchasing ***
		$value = $numofshares*$CurrentPrice;
		$fee = $value*.05;
		//$sqltemp = "UPDATE Capital SET balance=5000 WHERE email = '$email' ";//USE THIS TO RESET THE BALANCE IN DB, TESTING PURPOSES
    ...
    echo "<br>Your New Account Balance is $$balance"; 
	//echo $symbol;
	$sql6 = "UPDATE Capital SET balance = '$balance' WHERE email = '$email' AND leagueName = '$leagueTitle' ";
...
<label for="fname">Number of Shares</label>
...
<label for="balance">Current Balance:$<?php echo $balance; ?></label>
</div>
